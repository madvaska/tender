...
DDRjQuery(function ($) {
	...
	DDR.Menu.Providers.BaseRenderer.prototype.addCovering = function () {
		...
		var coveringBase = $("<a style='position:absolute;display:block;border:0;padding:0;margin:0;top:0;left:0;bottom:0;right:0;text-decoration:none'><span style='visibility:hidden'/></a>").css("background",  "url(" + me.dnnNavParams.PathSystemImage + "spacer.gif)");
		var overrideDimensions = !$.support.boxModel;
